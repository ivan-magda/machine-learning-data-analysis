...
#### Минимизация риска
- оптимальный байесовский классификатор минимизирует и функционал среднего риска.


#### метод опорных веторов
- Это просто линейный классификатор с кусочно-линейной функцией потерь и L2-регуляризатором.
...
- А в случае линейно неразделимой выборки просто добавляется возможность попадания объектов в полосу и штрафы за эти попадания. 
